...
URL = "https://www.gucci.com/us/en/ca/women/ready-to-wear-for-women-c-women-readytowear"

async def scrape_gucci_readytowear():
    async with async_playwright() as p:
        ...
        # Save to JSON
        with open("readytowear.json", "w", encoding="utf-8") as f:
            json.dump(results, f, ensure_ascii=False, indent=2)

        print(f"Saved {len(results)} items to readytowear.json.")
        await browser.close()

async def main():
    await scrape_gucci_readytowear()
