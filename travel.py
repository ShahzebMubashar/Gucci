...
URL = "https://www.gucci.com/us/en/ca/women/travel-for-women-c-women-accessories-lifestyle-bags-and-luggage"

async def scrape_gucci_travel():
    async with async_playwright() as p:
        ...
        # Save to JSON
        with open("travel.json", "w", encoding="utf-8") as f:
            json.dump(results, f, ensure_ascii=False, indent=2)

        print(f"Saved {len(results)} items to travel.json.")
        await browser.close()

async def main():
    await scrape_gucci_travel()
