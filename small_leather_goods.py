...
URL = "https://www.gucci.com/us/en/ca/women/wallets-and-small-accessories-for-women-c-women-accessories-wallets"

async def scrape_gucci_small_leather_goods():
    async with async_playwright() as p:
        ...
        # Save to JSON
        with open("small_leather_goods.json", "w", encoding="utf-8") as f:
            json.dump(results, f, ensure_ascii=False, indent=2)

        print(f"Saved {len(results)} items to small_leather_goods.json.")
        await browser.close()

async def main():
    await scrape_gucci_small_leather_goods()
